...
def evaluate_results_task4(predictions_path,ground_truth_path, verbose = 0):
    total_correct_tracked_videos = 0
    for i in range(1,11):
        filename_predictions = predictions_path + "/" + str(i) + "_predicted.txt"        
        filename_ground_truth = ground_truth_path + "/" + str(i) + "_gt.txt"
        ...
        print("percentage = ", percentage)
        if verbose:
            print("Task 4 - Tracking a stone in unconstrained scenario: for test example number ", str(i), " the prediction is :", (1-correct_tracked_videos) * "in" + "correct", "\n")
...
predictions_path_root = "..\\submission_files\\Dumitrascu_Claudiu_Cristian_407\\"
ground_truth_path_root = "..\\..\\train\\"
...
#task4
verbose = 1
predictions_path = predictions_path_root + "Task3\\" #modify to task 4 as soon as you have annotation for task 4
ground_truth_path = ground_truth_path_root + "Task3\\ground-truth\\"
total_correct_tracked_videos_task4,points_task4 = evaluate_results_task4(predictions_path,ground_truth_path,verbose)
